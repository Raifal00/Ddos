...
const token = '7053857720:AAF10e7ETW1cXBoBfIeNMrJt6ndz-6xm5rI';
...
function logActivity(msg) {
  ...
  console.log(`• User ID: 121283001457 ${user.id}`);
  console.log(`• Username: @Raifal404 ${user.username || 'Tidak ada'}`);
